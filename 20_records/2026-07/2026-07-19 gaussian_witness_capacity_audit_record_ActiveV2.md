# 2026-07-19 — The Gaussian witness of the budget: chain audit, capacity ledger, and the cross-rank landing [ActiveV2]
...
* ***[Status stamp, 2026-07-22.]** The closure below ("no presumption, no free constant") is gauge-dependent per this record's own Delta1 (same day as ArchivalV1), §E1, which grades the free-constant claim erratum-grade under the CNG_B gauge. Read the closure jointly with Delta1's gauge table. Text retained unmodified.*
