...
**⚠ SUPERSEDED IN PART — read with `ERRATUM_mode0_is_not_the_parabolic_port_20260813B.md`. The §1(i)/§2-headline identification of mode 0 with "the parabolic/Eisenstein component," and §4's billing of the kernel identity as equivalent to the conjecture, are both withdrawn there. §2's mode-matching, the must-be-zero band, the collapse, and §5 are unaffected.**
