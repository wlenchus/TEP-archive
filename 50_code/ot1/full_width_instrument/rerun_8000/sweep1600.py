...
RES='sweep1600_results_p1.json'
res=json.load(open(RES)) if os.path.exists(RES) else {}
H=np.load('/home/claude/ot1_8000/H_p1_1600.npy').astype(np.float64); Minv=np.load('/home/claude/ot1_8000/Minv_p1_1600.npy').astype(np.float64)
