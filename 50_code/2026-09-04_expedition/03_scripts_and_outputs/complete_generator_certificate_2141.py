...
N = 2141
M = 100000
path = '/home/claude/deposit_supplement_20260830/data/hecke_eigenvalues_doud2141_to1e5.csv'
...
gens = np.load('/tmp/claude-0/-home-claude/17b2fbcf-cb76-5cd8-bb47-c85d94234441/scratchpad/gens/gens_unique_2141.npy')
...
np.save('/home/claude/expedition_20260904/certificate_results_2141.npy', np.array(results, dtype=object), allow_pickle=True)
with open('/home/claude/expedition_20260904/certificate_results_2141.tsv', 'w') as f:
