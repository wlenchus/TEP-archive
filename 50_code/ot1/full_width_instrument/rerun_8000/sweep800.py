...
RES='sweep800_results_p1.json'
res=json.load(open(RES)) if os.path.exists(RES) else {}
H=np.load('/home/claude/ot1_8000/H_p1_800.npy').astype(np.float64); Minv=np.load('/home/claude/ot1_8000/Minv_p1_800.npy').astype(np.float64)
