...
gens = np.load('/tmp/claude-0/-home-claude/17b2fbcf-cb76-5cd8-bb47-c85d94234441/scratchpad/gens/gens_unique.npy')
...
np.save('/home/claude/expedition_20260904/certificate_results.npy', np.array(results, dtype=object), allow_pickle=True)
with open('/home/claude/expedition_20260904/certificate_results.tsv', 'w') as f:
