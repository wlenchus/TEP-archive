...
RES='sweep8000_results_p2.json'
res=json.load(open(RES)) if os.path.exists(RES) else {}
H=np.load('/home/claude/ot1_8000/H_p2_8000.npy').astype(np.float64); Minv=np.load('/home/claude/ot1_8000/Minv_p2_8000.npy').astype(np.float64)
