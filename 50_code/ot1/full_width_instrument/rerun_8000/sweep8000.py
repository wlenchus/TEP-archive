...
P=1000003; NCOL=2401; DEPTH=2400
...
RES='sweep8000_results_p1.json'
res=json.load(open(RES)) if os.path.exists(RES) else {}
H=np.load('/home/claude/ot1_8000/H_p1_8000.npy').astype(np.float64); Minv=np.load('/home/claude/ot1_8000/Minv_p1_8000.npy').astype(np.float64)
