...
"""
open('/tmp/ad_2141.gp','w').write(gp_script)
subprocess.Popen('nohup gp -q -f /tmp/ad_2141.gp > /tmp/ad_2141.gp.log 2>&1 &', shell=True)
print('gp launched in background -> /tmp/ad_2141.gp.log')
